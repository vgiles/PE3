...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 692.0, 463.0, 369.0, 196.0 ],
...
,
					"saved_object_attributes" : 					{
						...
						"patchername_fallback" : "~/Music/Ableton/Factory Packs/Max for Live Essentials/Max Audio Effect/Convolution Reverb/Convolution Reverb.amxd"
					}
,
					"snapshot" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 15.0, 186.0, 33.0, 22.0 ],
					"text" : "read"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 216.0, 113.0, 22.0 ],
					"text" : "buffer~ transientSrc"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 328.850000000000023, 298.0, 29.5, 22.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 321.600000000000023, 269.0, 44.0, 22.0 ],
					"text" : "sel 0 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 321.600000000000023, 236.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 524.0, 576.0, 84.0, 22.0 ],
					"text" : "mc.unpack~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 13.0,
					"id" : "obj-22",
					"items" : [ "IAC Driver Bus 1", ",", "Arturia BeatStep Pro Arturia BeatStepPro", ",", "Arturia BeatStep Pro BeatStepPro OutEditor", ",", "to Max 1", ",", "to Max 2" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 524.0, 662.0, 45.0, 45.0 ]
				}
...
, 			{
				"name" : "Convolution Reverb.amxd",
				"bootpath" : "~/Music/Ableton/Factory Packs/Max for Live Essentials/Max Audio Effect/Convolution Reverb",
				"patcherrelativepath" : "../../../../Music/Ableton/Factory Packs/Max for Live Essentials/Max Audio Effect/Convolution Reverb",
				"type" : "amxd",
				"implicit" : 1
			}
, 			{
